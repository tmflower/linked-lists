...
describe("getAt", function() {
  it("gets val at index", function() {
    let lst = new LinkedList([5, 10, 15, 20, 25, 30]);

    expect(lst.getAt(9)).toBe("Error: invalid index");
...
describe("setAt", function() {
  it("sets val at index", function() {
    ...
    expect(lst.setAt(6, 5)).toBe("Error: invalid index");
  });
});
